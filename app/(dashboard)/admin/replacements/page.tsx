  ...
  return (
    <PageShell>
      ...
      <section className="grid gap-4 md:grid-cols-4">
        ...
        <StatsCard title="Active" value={replacements.filter((r) => r.status === "Active").length.toString()} />
        <StatsCard title="Scheduled" value={replacements.filter((r) => r.status === "Scheduled").length.toString()} />
        <StatsCard title="Expired" value={replacements.filter((r) => r.status === "Expired").length.toString()} />
      </section>
