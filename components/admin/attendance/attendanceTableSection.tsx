...
export function AttendanceTableSection({classAttendance}: {classAttendance: AttendanceItem[]}) {
    return (
        <TableSection>
            <TableSectionHeader
...
export function TeacherAttendanceSection({teacherAttendance}: {teacherAttendance: AttendanceTeacherItem[]}) {
return (
    <TableSection>
        <TableSectionHeader
